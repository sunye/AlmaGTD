 ...
 * @version 1.0.0
 */
public final class CommandeSupprimerProjet implements Commande {
	 ...
	 * @param c Le callback.
	 */
	public CommandeSupprimerProjet(final String i, final IProjet p, final CallBack<String> c) {
		super();
	...
	public void execute() throws RemoteException {
		...
		if ((proj != null) && (uti != null) && (this.identification.equalsIgnoreCase(this.projet.getCreateur().getIdentifiantServeur()))) {
			this.projetServiceRemote.removeProjetById(proj.getIdentifiantServeur());
			this.callback.onSucces("Projet supprime");
		} else {
			if (proj == null) {
