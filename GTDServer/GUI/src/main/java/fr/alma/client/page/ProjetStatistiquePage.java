...
public class ProjetStatistiquePage implements IPageIHM  {
	
	private List<Integer> data;

	public ProjetStatistiquePage(List<Integer> projetStats) {
		data=projetStats;
	}
	...
	public Portal getPortalPanel() {
		...
		portlet.setHeading("Statistique - Projet");
		configPanel(portlet);
	...
	private ChartModel getPieChartData() {  
		ChartModel cm = new ChartModel("Nombre de projets par mois", "font-size: 14px; font-family: Verdana; text-align: center;padding:10px;");  
