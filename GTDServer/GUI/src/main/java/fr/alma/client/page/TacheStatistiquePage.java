...
public class TacheStatistiquePage implements IPageIHM  {
	
	private List<Integer> data;

	public TacheStatistiquePage(List<Integer> tacheStats) {
		data=tacheStats;
	}
	...
	public Portal getPortalPanel() {
		...
		portlet.setHeading("Statistique - Tâche");
		configPanel(portlet);
	...
	private ChartModel getPieChartData() {  
		ChartModel cm = new ChartModel("Nombre de tâches par mois", "font-size: 14px; font-family: Verdana; text-align: center;padding:10px;");  
