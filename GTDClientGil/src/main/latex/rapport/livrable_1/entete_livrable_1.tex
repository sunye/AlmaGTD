...
\begin{large}\textbf{Analyse du problème}\end{large}}
...
\begin{flushright}
	...
	{\fontfamily{ppl}\fontseries{b}\fontsize{0.8cm}{1.45cm}\selectfont Analyse du problème}
	
	\vspace{1cm}
	
	{\Large Projet : Livrable 1}\\
